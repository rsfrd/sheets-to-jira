...
def sheet_to_jira():
    ...
    survey_combined.insert(1,survey_combined.pop([x for x, y in enumerate(survey_combined) if y[0] == 'Company Name'][0]))
    survey_combined.insert(2,survey_combined.pop([x for x, y in enumerate(survey_combined) if y[0] == 'Name'][0]))
    survey_combined.insert(3,survey_combined.pop([x for x, y in enumerate(survey_combined) if y[0] == 'Email Address'][0]))
